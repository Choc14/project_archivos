...
urlpatterns = [
    ...
    path('users/change_username/', login_required(views.ChangeUsername.as_view()), name='update_u'),
    path('users/change_password/', login_required(views.ChangePassword.as_view()), name='update_p'),
